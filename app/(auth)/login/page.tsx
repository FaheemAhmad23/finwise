    ...
    <div className="min-h-screen bg-[#0D0F14] flex items-center justify-center px-4 py-12">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-1 text-sm">Smart money management, simplified</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#151820] px-3 text-slate-500">or continue with</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-white text-sm font-medium transition flex items-center justify-center gap-3"
          >
